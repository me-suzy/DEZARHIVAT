...
Support:  http://www.donerightscripts.com/cgi-bin/members/support.cgi?file=seranker
...
http://www.donerightscripts.com/cgi-bin/members/support.cgi?file=seranker
...
1)  Package
-----------------------------------------------------------------------------
After you have unzipped the file seranker.zip, you should get the following files:

admin.cgi          		- personal admin script
customize.cgi			- part of admin script
email.cgi			- part of admin script
seranker.cgi     		- main script
...
- Perl 5
- Libwww Module
- If you are running NT, you will also need the libnet module to send email.
...
2. Upload every file in ASCII format into your cgi-bin (preferably in a folder called "seranker")
...
5. Run the admin.cgi script to setup your variables and you're done.
   To access the actual ranker script, run seranker.cgi.
-----------------------------------------------------------------------------
...
1b. Open the following files and enter in the direct data path to your seranker directory in the variable "$path".
    Ex. $path = "/www/root/website/cgi-bin/seranker/"; # With a slash at the end as shown
	admin.cgi
	customize.cgi
	email.cgi
	seranker.cgi
