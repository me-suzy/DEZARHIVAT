...
<td>
<p class="TableMiddleHead">Install PHP-Nuke (2/2)</p>
<!--
...
$SITENAME = $sitename;
$SITEURL = "http://<cpanel print="DOMAIN">/community";
$TITLE = $title;
$BEGINDATE = $begindate;
...
foreach($CONFIG_FILE AS $FILE){
	if(is_file($FILE)){
		...
		$contents = str_replace("<OLDARTICLECOUNT>", $OLDARTICLECOUNT, $contents);
		$contents = str_replace("<FOOTER>", $FOOTER, $contents);
		$contents = str_replace("<ULTRAMODE>", $ULTRAMODE, $contents);
		...
		$contents = str_replace("<USER_REGDATE>", $USER_REGDATE, $contents);
...
<p align="left">We only offer auto-installation and auto-configuration of <span class="Emphasize">PHP-Nuke</span> but do not offer any kind of support. If you need support, please visit the <a href="http://www.nukesupport.com/" target="_blank">Support Forum</a>.</p>
<p align="left">Now you can enter the admin area and setup <span class="Emphasize">PHP-Nuke</span>.</p>
<p class="BoldText" align="center">URL info:</p>
<p align="left">You need a username and a password to enter the admin area. Your username is <span class="Hint"><b>admin</b></span>. Your password is <span class="Hint"><b><cpanel print="$FORM{'password'}"></b></span>. The full URL to the admin area <span class="Hint"><b>(Bookmark this!)</b></span>: <a href="<?=$SITEURL?>/admin.php" target="blank"><?=$SITEURL?>/admin.php</a></p>
<p align="left">The full URL to <span class="Emphasize">PHP-Nuke</span>: <a href="<?=$SITEURL?>" target="blank"><?=$SITEURL?></a></p>
<p>&nbsp;</p>
