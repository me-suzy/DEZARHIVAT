...
<tr> 
<td>
<p class="TableMiddleHead">Install phpBB2 (2/2)</p>
<!--
...
$SCRIPTPATH = "<cpanel print="$homedir">/public_html/forum/";
$DEPOT = "/var/autoinstall/english/forum";
...
foreach($CONFIG_FILE AS $FILE){
	if(is_file($FILE)){
		...
		$contents = str_replace("<SMALLDESCRIPTION>", $SMALLDESCRIPTION, $contents);
		$contents = str_replace("<EMAILSIGNATURE>", $EMAILSIGNATURE, $contents);
...
<p align="left">We only offer auto-installation and auto-configuration of <span class="Emphasize">phpBB2</span> but do not offer any kind of support. If you need support, please visit the <a href="http://phpbb.com/" target="_blank">Support Forum</a>.</p>
<p align="left">Now you can enter the admin area and setup <span class="Emphasize">phpBB2</span>.</p>
<p class="BoldText" align="center">URL info:</p>
<p align="left">You need a username and a password to enter the admin area. Your username is <span class="Hint"><b>admin</b></span>. Your password is <span class="Hint"><b><cpanel print="$FORM{'password'}"></b></span>. The full URL to the admin area <span class="Hint"><b>(Bookmark this!)</b></span>: <a href="http://<cpanel print="DOMAIN">/forum/admin/" target="blank">http://<cpanel print="DOMAIN">/forum/admin/</a></p>
<p align="left">The full URL to <span class="Emphasize">phpBB2</span>: <a href="http://<cpanel print="DOMAIN">/forum/" target="blank">http://<cpanel print="DOMAIN">/forum/</a></p>
<p>&nbsp;</p>
