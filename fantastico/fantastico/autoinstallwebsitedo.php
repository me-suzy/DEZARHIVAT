...
<td>
<p class="TableMiddleHead">Install phpWebSite (2/2)</p>
<!--
...
<?
$MYSQLUSER = str_replace("-","",$connectuser);
$MYSQLDB = str_replace("-","",$connectdb);
$MYSQLPASS = $password;
$USER = "<cpanel print="$user">";
$DOMAIN = "<cpanel print="DOMAIN">";
$USER_ROOT = "<cpanel print="$homedir">/public_html/";
$SCRIPTPATH = "<cpanel print="$homedir">/public_html/website/";
$DEPOT = "/var/autoinstall/english/website";
$SQLDATA = $SCRIPTPATH."website.sql";
$ADMIN = "admin";
...
$CONFIG_FILE[]=$SCRIPTPATH."website.sql";
...
<p align="left">We only offer auto-installation and auto-configuration of <span class="Emphasize">phpWebSite</span> but do not offer any kind of support. If you need support, please visit the <a href="http://sourceforge.net/forum/?group_id=15539" target="_blank">Support Forum</a>.</p>
<p align="left">Now you can enter the admin area and setup <span class="Emphasize">phpWebsite</span>.</p>
<p class="BoldText" align="center">URL info:</p>
<p align="left">You need a username and a password to enter the admin area. Your username is <span class="Hint"><b>admin</b></span>. Your password is <span class="Hint"><b><cpanel print="$FORM{'password'}"></b></span>. The full URL to the admin area <span class="Hint"><b>(Bookmark this!)</b></span>: <a href="http://<cpanel print="DOMAIN">/website/admin.php" target="blank">http://<cpanel print="DOMAIN">/website/admin.php</a></p>
<p align="left">The full URL to phpWebsite: <a href="http://<cpanel print="DOMAIN">/website/" target="blank">http://<cpanel print="DOMAIN">/website/</a></p>
<p>&nbsp;</p>
