Web Wiz Guide ASP Discussion Forum realease v4.52
...
in order to use the e-mail features of the forum. An SMTP server also needs to be installed 
...
1. Unzip all the files keeping them in there zipped directories.

   Files must be run through an ASP enabled web sever (not the same as CGI).

2. The Forum can be configured online by using the files in the admin folder. After logging 
into the admin section you will be given a set of options from which you can turn on e-mail 
notifcation, customise the forum by changing the colours of the forum, enter fourm names and 
descriptions, and change the username and password of the forum adminstrator(which is highly 
recommened for higher security) and make forum users moderators so they can edit or delete posts. 

3. The username password for the admin files is the same as the Administration for the Forum.

4. If you alter the Adminstration Username and Password don't forget what they are as you will 
not beable to get to the configuration files or Administer the database without them!!!!


6. To Administer the database you will need to login to the Forum with the username (unless you
change thses settings though the admin files): -

      Administrator

and with the password (lowercase): -

      letmein

Once you have logged in as Administrator you can then Edit or Delete any posts in the
forum. I would recommend that you change the password, this can be done by clicking on the 
Edit Profile button shown at the top of the forum once you have logged in or by using the 
admin section.




7. If you are having problems with the forum running then edit the files common.asp with a 
text editor where you can select to use a diffrent OBDC database driver or use DSN if you are 
able to setup DSN on your web server.
...
Brinkster Users
===========================================================================================
If you are using the forum on Brinkster then you need to follow the steps below to configure 
the forum on Brinkster: -

1. You should find a folder on your Brinkster web space called db, you will need to place the 
forum.mdb database in this folder. 

2. Edit the 2 files called common.asp with a text editor and uncomment the Brinkster database 
...
Common database error when using the forum
===========================================================================================
...
Problems running the ASP Discussion Forum
===========================================================================================
...
If you would like to remove the powered by links from the application then please read the
'Remove Powered By Web Wiz Guide button links' section in the admin section of the Forum.
